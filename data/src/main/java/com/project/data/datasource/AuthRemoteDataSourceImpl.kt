...
class AuthRemoteDataSourceImpl @Inject constructor(
    ...
    override suspend fun login(idToken: String): ApiResponse<LoginResponseData>? {
    ...
    override suspend fun signUp(idToken: String, nickname: String, myTeam: String): SignUpResponse? {
